        ...
        <div className="flex flex-col md:flex-row gap-12 md:gap-8 justify-between">
          ...
          <div className="flex flex-col gap-5 max-w-xs">
            ...
            <div className="flex items-center gap-3 mt-1">
              <SocialIcon href="https://www.instagram.com/clubquisine/" ariaLabel="Instagram">
              ...
              {/* Logo fetched from https://cdn.helloasso.com/images/header_public/badge-helloasso.svg 
                  Modified for minimalistic design */}
              <SocialIcon href="https://www.helloasso.com/associations/club-quisine" ariaLabel="HelloAsso">
                <svg width="16" height="16" viewBox="0 0 141.9 141.76" fill="currentColor" >
                  <path class="cls-1" d="M42.61,113.83c-21.88-24.82-7.28-87.55,2-87.55C26.69,25.92-3.56,37.69.51,79.65a71.1,71.1,0,0,0,113.71,47.49C79.92,151.66,56.68,129.79,42.61,113.83Z"/><path class="cls-2" d="M122.71,71.67c-18.14,36.28-73.77,51.56-80.1,42.16,10.87,15.78,37.84,37.88,71.83,13.15A70.92,70.92,0,0,0,97.73,5.26C136.15,22.32,132.26,52.57,122.71,71.67Z"/><path class="cls-3" d="M44.61,26.28c39.24-4.21,83.74,36,78.1,45.39,11-18.74,13.58-49.35-24.82-66.42A71.14,71.14,0,0,0,.65,80.66C-2.13,38.92,29.94,27.85,44.61,26.28Z"/>
                </svg>
              </SocialIcon>
            </div>
          </div>
