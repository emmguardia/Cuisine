...
export default function Header({ solid = false }) {
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-10 h-[90px] flex items-center justify-between">
        ...
        <a href="/" className="flex-shrink-0 group">
          <img
            src="/images/logo.png"
            alt="Club Quisine"
            className={`h-[88px] w-auto transition-all duration-300 group-hover:scale-105 ${
